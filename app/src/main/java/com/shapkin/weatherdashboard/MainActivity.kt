package com.shapkin.weatherdashboard
...
import com.shapkin.weatherdashboard.ui.theme.WeatherDashboardTheme
import com.shapkin.weatherdashboard.viewmodel.WeatherViewModel
...
fun WeatherDashboardScreen(
    ...
    Column(
        ...
        WeatherCard(
            emoji = "🌡",
            title = "Temperature",
            value = weatherState.temperatyre?.let { "$it℃" } ?: "-",
            isLoading = weatherState.isLoading && weatherState.temperatyre == null
        )
        WeatherCard(
            emoji = "💧",
            title = "Humidity",
